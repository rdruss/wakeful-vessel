...
----
$ git clone git@github.com:rdruss/wakeful-vessel
...
You can interact with the example application using the form at the secured endpoint URL and the link:http://launcher.fabric8.io/docs/thorntail-runtime.html#rhsso-realm-model_secured[provided users].
...
== More Information
You can learn more about this example application and rest of the Thorntail runtime in the link:http://launcher.fabric8.io/docs/thorntail-runtime.html[Thorntail Runtime Guide].

To run the integration test on the Secured HTTP API example application follow the steps in the link:https://launcher.fabric8.io/docs/thorntail-runtime.html#running-the-wildflyswarm-secured-example-application-integration-tests_secured[Secured Example Application documentation].
